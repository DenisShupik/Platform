...
namespace SharedKernel.TypeGenerator;

[Generator(LanguageNames.CSharp)]
public sealed class Generator : IIncrementalGenerator
{
    private const string Namespace = "SharedKernel.TypeGenerator";
    ...
    private const string GenerateAttributes =
        """
        // <auto-generated/>
    ...
    public void Initialize(IncrementalGeneratorInitializationContext context)
    {
        ...
        {
            postInitContext.AddSource($"{Namespace}.g.cs",
    ...
    {
        var omitSym = compilation.GetTypeByMetadataName($"{Namespace}.OmitAttribute");
        var includeSym = compilation.GetTypeByMetadataName($"{Namespace}.IncludeAttribute");
