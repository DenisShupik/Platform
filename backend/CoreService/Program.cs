...
builder.Services.AddWolverine(options =>
{
    ...
    options.PublishMessage<ThreadApprovedEvent>().ToRabbitExchange(serviceExchangeName);
    options.PublishMessage<ThreadRejectedEvent>().ToRabbitExchange(serviceExchangeName);
