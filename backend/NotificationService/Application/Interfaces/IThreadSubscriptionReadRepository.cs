...
public interface IThreadSubscriptionReadRepository
{
    ...
    Task<IReadOnlyList<T>> GetWatchedThreadsAsync<T>(GetWatchedThreadsPagedQuery<T> query,
        CancellationToken cancellationToken);

    Task<Count> GetWatchedThreadsCountAsync(GetWatchedThreadsCountQuery query,
        CancellationToken cancellationToken);
