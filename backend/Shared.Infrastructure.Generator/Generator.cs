...
public sealed class Generator : IIncrementalGenerator
{
        ...
        GenerationType generationType)
    {
        ...
        // Если Single - потребуется Shared.Application.Enums и System.Linq
        if (generationType == GenerationType.Single)
        {
            requiredUsings.Add("Shared.Application.Enums");
            requiredUsings.Add("System.Linq");
        }
        else
        {
            // при Multi мы используем ApplySort extension (в вашем примере это static Shared.Infrastructure.Extensions.QueryableExtensions)
            requiredUsings.Add("static Shared.Infrastructure.Extensions.QueryableExtensions");
        }
