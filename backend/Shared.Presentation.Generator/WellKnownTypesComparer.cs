...
public sealed class WellKnownTypesComparer : IEqualityComparer<WellKnownTypes>
{
    ...
    public bool Equals(WellKnownTypes? x, WellKnownTypes? y)
    {
        ...
        return SymbolEqualityComparer.Default.Equals(x.GenerateBindAttribute, y.GenerateBindAttribute) &&
               SymbolEqualityComparer.Default.Equals(x.FromRouteAttribute, y.FromRouteAttribute) &&
