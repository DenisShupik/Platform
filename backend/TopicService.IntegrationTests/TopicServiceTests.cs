...
public sealed class TopicServiceTests
{
    ...
    public TopicServiceTests(IntegrationTestFactory factory)
    {
        _factory = factory;
    ...
    public async Task CreateThread_ReturnsOk()
    {
        ...
        var response = await client.PostAsJsonAsync("api/topics", new CreateTopicRequest
        {
            Title = title
        });
