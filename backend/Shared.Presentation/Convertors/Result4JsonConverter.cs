    ...
    where TError3 : Error
{
    ...
    private static readonly byte[] Error3TypeNameUtf8 = Encoding.UTF8.GetBytes(typeof(TError3).Name);
        ...
        JsonSerializerOptions options)
    {
        ...
        Result<TValue, TError1, TError2, TError3>? result = null;
        ...
        while (reader.Read())
        {
            ...
            if (reader.TokenType == JsonTokenType.PropertyName)
            {
                ...
                else if (reader.ValueTextEquals("error"u8))
                {
                    ...
                    else if (reader.ValueTextEquals(Error3TypeNameUtf8))
                        targetType = typeof(TError3);
                    else
                    ...
                    {
                        TError1 e1 => (Result<TValue, TError1, TError2, TError3>)e1,
                        TError2 e2 => (Result<TValue, TError1, TError2, TError3>)e2,
                        TError3 e3 => (Result<TValue, TError1, TError2, TError3>)e3,
