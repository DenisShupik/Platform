...
/// </summary>
public sealed class Unauthorized<T> : IResult, IEndpointMetadataProvider, IStatusCodeHttpResult
{
    /// <summary>
    ...
    static void IEndpointMetadataProvider.PopulateMetadata(MethodInfo method, EndpointBuilder builder)
    {
        ...
        builder.Metadata.Add(new ProducesResponseTypeMetadata(StatusCodes.Status401Unauthorized, typeof(T)));
    }
}