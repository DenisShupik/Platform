...
import type { GetCategoryStatsData, GetCategoryStatsResponse, GetCategoryData, GetCategoryResponse, GetCategoryThreadsCountData, GetCategoryThreadsCountResponse, GetCategoryThreadsData, GetCategoryThreadsResponse, CreateCategoryData, CreateCategoryResponse, GetForumsData, GetForumsResponse, CreateForumData, CreateForumResponse, GetForumData, GetForumResponse, GetPostsData, GetPostsResponse, GetThreadData, GetThreadResponse, GetThreadPostsCountData, GetThreadPostsCountResponse2, GetThreadPostsData, GetThreadPostsResponse, CreatePostData, CreatePostResponse, CreateThreadData, CreateThreadResponse, UploadAvatarData, UploadAvatarError, GetUsersData, GetUsersResponse, GetUserData, GetUserResponse } from './types.gen';
