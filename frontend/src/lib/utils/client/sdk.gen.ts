...
export const getUserNotificationCount = <ThrowOnError extends boolean = false>(options?: Options<GetUserNotificationCountData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetUserNotificationCountResponses, GetUserNotificationCountErrors, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const getUserNotification = <ThrowOnError extends boolean = false>(options?: Options<GetUserNotificationData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetUserNotificationResponses, GetUserNotificationErrors, ThrowOnError>({
        responseTransformer: getUserNotificationResponseTransformer,
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const markInternalNotificationAsRead = <ThrowOnError extends boolean = false>(options: Options<MarkInternalNotificationAsReadData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<MarkInternalNotificationAsReadResponses, MarkInternalNotificationAsReadErrors, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
