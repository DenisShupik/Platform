...
import type { GetWatchedThreadsCountData, GetWatchedThreadsCountErrors, GetWatchedThreadsCountResponses, GetWatchedThreadsPagedData, GetWatchedThreadsPagedErrors, GetWatchedThreadsPagedResponses } from './types.gen';
 ...
 */
export const getWatchedThreadsCount = <ThrowOnError extends boolean = false>(options?: Options<GetWatchedThreadsCountData, ThrowOnError>): RequestResult<GetWatchedThreadsCountResponses, GetWatchedThreadsCountErrors, ThrowOnError> => (options?.client ?? client).get<GetWatchedThreadsCountResponses, GetWatchedThreadsCountErrors, ThrowOnError>({
  security: [{ scheme: 'bearer', type: 'http' }],
