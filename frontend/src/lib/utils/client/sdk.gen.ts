...
export const getUsersByIds = <ThrowOnError extends boolean = false>(options: Options<GetUsersByIdsData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetUsersByIdsResponses, unknown, ThrowOnError>({
