...
export const getCategoriesLatestPost = <ThrowOnError extends boolean = false>(options: Options<GetCategoriesLatestPostData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetCategoriesLatestPostResponse, unknown, ThrowOnError>({
