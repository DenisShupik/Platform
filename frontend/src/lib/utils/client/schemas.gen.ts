...
export const AccessLevelSchema = {
    enum: [0, 1, 2],
    type: 'integer',
    'x-enum-varnames': ['Public', 'Authenticated', 'Restricted']
} as const;

export const AccessLevelErrorSchema = {
    type: 'object',
    anyOf: [
        {
            '$ref': '#/components/schemas/ForumAccessLevelError'
        },
        {
            '$ref': '#/components/schemas/CategoryAccessLevelError'
        },
        {
            '$ref': '#/components/schemas/ThreadAccessLevelError'
        }
    ],
    discriminator: {
        propertyName: '$type'
...
export const AccessRestrictedErrorSchema = {
    type: 'object',
    anyOf: [
        {
            '$ref': '#/components/schemas/AccessRestrictedErrorForumAccessRestrictedError'
        },
        {
            '$ref': '#/components/schemas/AccessRestrictedErrorCategoryAccessRestrictedError'
        },
        {
            '$ref': '#/components/schemas/AccessRestrictedErrorThreadAccessRestrictedError'
        }
    ],
    discriminator: {
        propertyName: '$type'
...
export const AccessRestrictedErrorCategoryAccessRestrictedErrorSchema = {
...
export const AccessRestrictedErrorForumAccessRestrictedErrorSchema = {
    required: ['forumId', 'userId', 'level', '$type'],
    properties: {
        '$type': {
            type: 'string',
            readOnly: true
...
export const AccessRestrictedErrorThreadAccessRestrictedErrorSchema = {
...
export const ForumAccessLevelErrorSchema = {
    required: ['forumId', 'userId', 'level', '$type'],
    type: 'object',
    properties: {
        '$type': {
...
export const ForumAccessRestrictedErrorSchema = {
    required: ['forumId', 'userId', 'level', '$type'],
    type: 'object',
    properties: {
        '$type': {
...
export const ThreadAccessLevelErrorSchema = {
    required: ['threadId', 'userId', 'level', '$type'],
    properties: {
        '$type': {
            type: 'string',
...
export const AccessRestrictedErrorCategoryAccessRestrictedErrorWritableSchema = {
...
export const AccessRestrictedErrorForumAccessRestrictedErrorWritableSchema = {
    required: ['forumId', 'userId', 'level'],
    properties: {
        forumId: {
            '$ref': '#/components/schemas/ForumId'
        },
...
export const AccessRestrictedErrorThreadAccessRestrictedErrorWritableSchema = {
...
export const ForumAccessLevelErrorWritableSchema = {
    required: ['forumId', 'userId', 'level'],
    type: 'object',
    properties: {
        forumId: {
...
export const ForumAccessRestrictedErrorWritableSchema = {
    required: ['forumId', 'userId', 'level'],
    type: 'object',
    properties: {
        forumId: {
...
export const ThreadAccessLevelErrorWritableSchema = {
    required: ['threadId', 'userId', 'level'],
    properties: {
        threadId: {
            pattern: '^(?!00000000-0000-0000-0000-000000000000$)',
