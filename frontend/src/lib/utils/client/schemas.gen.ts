...
export const AdministrationAllowedActionsDtoSchema = {
  required: [
    'canManageAnyAuthorization',
    'canManageAnySanctions',
    'canManagePlatformAuthorization',
    'canManagePlatformSanctions'
  ],
  type: 'object',
  properties: {
    canManageAnyAuthorization: {
...
export const AuthorizationAssignmentIdSchema = {
  pattern: '^(?!00000000-0000-0000-0000-000000000000$)',
  type: 'string',
  format: 'uuid',
  'x-value-object': 'AuthorizationAssignmentId'
} as const;

export const AuthorizationScopeNotFoundErrorSchema = {
  required: [
    'scopeType',
    '$type'
  ],
  ...
  properties: {
    $type: {
      const: 'AuthorizationScopeNotFoundError',
      type: 'string',
      readOnly: true
    },
    scopeType: {
      $ref: '#/components/schemas/AuthorizationScopeType'
    }
  }
} as const;

export const AuthorizationScopeTypeSchema = {
  enum: [
    'platform',
    'forum',
    'category',
...
export const CapabilityCodeSchema = {
  enum: [
    'manageStructure',
...
export const CapabilityDefinitionDtoSchema = {
  required: [
    'capability',
    'allowedScopes'
  ],
...
export const CapabilityGrantDtoSchema = {
  required: [
    'capabilityGrantId',
    'assignmentId',
    'userId',
  ...
  properties: {
    capabilityGrantId: {
      $ref: '#/components/schemas/CapabilityGrantId'
    },
    assignmentId: {
      $ref: '#/components/schemas/AuthorizationAssignmentId'
    },
    userId: {
    ...
    sourceType: {
      $ref: '#/components/schemas/GrantSourceType'
    },
    grantedBy: {
      oneOf: [
        {
...
export const CapabilityGrantIdSchema = {
  ...
  type: 'string',
  format: 'uuid',
  'x-value-object': 'CapabilityGrantId'
} as const;

export const CapabilityGrantNotFoundErrorSchema = {
  required: [
    'capabilityGrantId',
    '$type'
  ],
  ...
  properties: {
    $type: {
      const: 'CapabilityGrantNotFoundError',
      type: 'string',
      readOnly: true
    },
    capabilityGrantId: {
...
export const CapabilityNotApplicableToScopeErrorSchema = {
  required: [
    'capability',
    'scopeType',
    '$type'
  ...
  properties: {
    $type: {
      const: 'CapabilityNotApplicableToScopeError',
      type: 'string',
      readOnly: true
    },
    capability: {
...
export const CategoryAllowedActionsDtoSchema = {
  required: [
    'canManageStructure',
    'canViewUnpublishedThreads',
    'canApproveThread',
    'canRejectThread',
    'canEditAnyPost',
    'canDeleteAnyPost',
...
export const CategoryModeratorAppointmentDtoSchema = {
  required: [
    'assignmentId',
    'userId',
    'grantedBy',
...
export const CategoryModeratorAppointmentNotFoundErrorSchema = {
  required: [
    'userId',
    'categoryId',
    '$type'
  ...
  properties: {
    $type: {
      const: 'CategoryModeratorAppointmentNotFoundError',
      type: 'string',
      readOnly: true
    },
    userId: {
...
export const DuplicateCapabilityGrantErrorSchema = {
  required: [
    'userId',
    'capability',
    '$type'
  ...
  properties: {
    $type: {
      const: 'DuplicateCapabilityGrantError',
      type: 'string',
      readOnly: true
    },
    userId: {
...
export const DuplicateCategoryModeratorAppointmentErrorSchema = {
  required: [
    'userId',
    'categoryId',
    '$type'
  ...
  properties: {
    $type: {
      const: 'DuplicateCategoryModeratorAppointmentError',
      type: 'string',
      readOnly: true
    },
    userId: {
...
export const DuplicateForumModeratorAppointmentErrorSchema = {
  required: [
    'userId',
    'forumId',
    '$type'
  ...
  properties: {
    $type: {
      const: 'DuplicateForumModeratorAppointmentError',
      type: 'string',
      readOnly: true
    },
    userId: {
...
export const DuplicateForumSanctionErrorSchema = {
  required: [
    'userId',
    'sanctionType',
    '$type'
  ...
  properties: {
    $type: {
      const: 'DuplicateForumSanctionError',
      type: 'string',
      readOnly: true
    },
    userId: {
    ...
    sanctionType: {
      $ref: '#/components/schemas/ForumSanctionType'
    }
  }
} as const;

export const DuplicatePlatformAdministratorAppointmentErrorSchema = {
  required: [
    'userId',
    '$type'
  ],
  ...
  properties: {
    $type: {
      const: 'DuplicatePlatformAdministratorAppointmentError',
      type: 'string',
      readOnly: true
    },
    userId: {
...
export const ForumAllowedActionsDtoSchema = {
  required: [
    'canManageStructure',
...
export const ForumModeratorAppointmentDtoSchema = {
  required: [
    'assignmentId',
    'userId',
    'grantedBy',
...
export const ForumModeratorAppointmentNotFoundErrorSchema = {
  required: [
    'userId',
    'forumId',
    '$type'
  ...
  properties: {
    $type: {
      const: 'ForumModeratorAppointmentNotFoundError',
      type: 'string',
      readOnly: true
    },
    userId: {
...
export const ForumSanctionDtoSchema = {
  required: [
    'forumSanctionId',
    'userId',
    'type',
  ...
  properties: {
    forumSanctionId: {
      $ref: '#/components/schemas/ForumSanctionId'
    },
    userId: {
      $ref: '#/components/schemas/UserId'
    },
    ...
    reason: {
      $ref: '#/components/schemas/ForumSanctionReason'
    },
    issuedBy: {
      $ref: '#/components/schemas/UserId'
    },
...
export const ForumSanctionIdSchema = {
  pattern: '^(?!00000000-0000-0000-0000-000000000000$)',
  type: 'string',
  format: 'uuid',
  'x-value-object': 'ForumSanctionId'
} as const;

export const ForumSanctionNotFoundErrorSchema = {
  required: [
    'forumSanctionId',
    '$type'
  ],
  ...
  properties: {
    $type: {
      const: 'ForumSanctionNotFoundError',
      type: 'string',
      readOnly: true
    },
    forumSanctionId: {
...
export const ForumSanctionReasonSchema = {
  maxLength: 500,
  minLength: 3,
  pattern: '^(?!\\s*$).+',
  type: 'string',
  'x-value-object': 'ForumSanctionReason'
} as const;

export const ForumSanctionTypeSchema = {
  enum: [
    'readOnly',
    'noAccess'
  ],
...
export const GrantCapabilityRequestBodySchema = {
  required: [
    'userId',
    'capability',
    'scopeType',
...
export const GrantSourceTypeSchema = {
  enum: [
    'direct',
...
export const InsufficientPermissionToEditHeaderPostErrorSchema = {
  required: [
    '$type'
  ],
  type: 'object',
  properties: {
    $type: {
      const: 'InsufficientPermissionToEditHeaderPostError',
      type: 'string',
      readOnly: true
    }
  }
...
export const InvalidAuthorizationScopeErrorSchema = {
  required: [
    '$type'
  ],
  type: 'object',
  properties: {
    $type: {
      const: 'InvalidAuthorizationScopeError',
      type: 'string',
      readOnly: true
    }
  }
...
export const InvalidCapabilityGrantValidityErrorSchema = {
  required: [
    '$type'
  ],
  type: 'object',
  properties: {
    $type: {
      const: 'InvalidCapabilityGrantValidityError',
      type: 'string',
      readOnly: true
    }
  }
...
export const InvalidCategoryModeratorValidityErrorSchema = {
  required: [
    '$type'
  ],
  type: 'object',
  properties: {
    $type: {
      const: 'InvalidCategoryModeratorValidityError',
      type: 'string',
      readOnly: true
    }
  }
...
export const InvalidForumModeratorValidityErrorSchema = {
  required: [
    '$type'
  ],
  type: 'object',
  properties: {
    $type: {
      const: 'InvalidForumModeratorValidityError',
      type: 'string',
      readOnly: true
    }
  }
...
export const InvalidForumSanctionValidityErrorSchema = {
  required: [
    '$type'
  ],
  type: 'object',
  properties: {
    $type: {
      const: 'InvalidForumSanctionValidityError',
      type: 'string',
      readOnly: true
    }
  }
...
export const IssueForumSanctionRequestBodySchema = {
  required: [
    'userId',
    'type',
    'scopeType',
...
export const LastPlatformAdministratorErrorSchema = {
  required: [
    '$type'
  ],
  type: 'object',
  properties: {
    $type: {
      const: 'LastPlatformAdministratorError',
      type: 'string',
      readOnly: true
    }
  }
...
export const PlatformAdministratorAppointmentDtoSchema = {
  required: [
    'assignmentId',
    'userId',
    'grantedBy',
...
export const PlatformAdministratorAppointmentNotFoundErrorSchema = {
  required: [
    'userId',
    '$type'
  ],
  ...
  properties: {
    $type: {
      const: 'PlatformAdministratorAppointmentNotFoundError',
      type: 'string',
      readOnly: true
    },
    userId: {
...
export const PlatformAllowedActionsDtoSchema = {
  required: [
    'canManageStructure',
    'canManageAuthorization',
    'canManageSanctions'
...
export const SearchCursorSchema = {
  maxLength: 1024,
  minLength: 1,
  pattern: '^(?!\\s*$).+',
  type: 'string',
  'x-value-object': 'SearchCursor'
} as const;
...
export const ThreadAllowedActionsDtoSchema = {
  required: [
    'canViewUnpublishedThreads',
    'canApproveThread',
    'canRejectThread',
...
export const PagedListOfThreadSummaryDtoSchema = {
  required: [
    'items',
    'totalCount'
  ],
...
export const ThreadSummaryDtoSchema = {
  required: [
    'threadId',
    'categoryId',
    'title',
...
export const UsernameSearchTermSchema = {
  maxLength: 64,
  minLength: 1,
  pattern: '^(?!\\s*$).+',
  type: 'string',
  'x-value-object': 'UsernameSearchTerm'
} as const;

export const AuthorizationScopeNotFoundErrorWritableSchema = {
  required: [
    'scopeType'
  ],
  type: 'object',
...
export const CapabilityGrantNotFoundErrorWritableSchema = {
  required: [
    'capabilityGrantId'
  ],
  type: 'object',
...
export const CapabilityNotApplicableToScopeErrorWritableSchema = {
  required: [
    'capability',
    'scopeType'
  ],
...
export const CategoryModeratorAppointmentNotFoundErrorWritableSchema = {
  required: [
    'userId',
    'categoryId'
  ],
...
export const DuplicateCapabilityGrantErrorWritableSchema = {
  required: [
    'userId',
    'capability'
  ],
...
export const DuplicateCategoryModeratorAppointmentErrorWritableSchema = {
  required: [
    'userId',
    'categoryId'
  ],
...
export const DuplicateForumModeratorAppointmentErrorWritableSchema = {
  required: [
    'userId',
    'forumId'
  ],
...
export const DuplicateForumSanctionErrorWritableSchema = {
  required: [
    'userId',
    'sanctionType'
  ],
...
export const DuplicatePlatformAdministratorAppointmentErrorWritableSchema = {
  required: [
    'userId'
  ],
  type: 'object',
...
export const ForumModeratorAppointmentNotFoundErrorWritableSchema = {
  required: [
    'userId',
    'forumId'
  ],
...
export const ForumSanctionNotFoundErrorWritableSchema = {
  required: [
    'forumSanctionId'
  ],
  type: 'object',
...
export const PlatformAdministratorAppointmentNotFoundErrorWritableSchema = {
  required: [
    'userId'
  ],
  type: 'object',
