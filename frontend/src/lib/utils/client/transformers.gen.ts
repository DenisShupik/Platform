...
export const getUserNotificationCountResponseTransformer = async (data: any): Promise<GetUserNotificationCountResponse> => {
    data = BigInt(data.toString());
    return data;
};
