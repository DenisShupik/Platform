...
import type { GetActivitiesPagedResponse, GetCategoriesPagedResponse, GetCategoryResponse, GetCategoryThreadsResponse, GetForumsCountResponse, GetForumsPagedResponse, GetForumResponse, GetPostIndexResponse, GetThreadsPagedResponse, GetThreadsCountResponse, GetThreadResponse, GetThreadPostsPagedResponse, GetInternalNotificationsPagedResponse, GetUsersResponse, GetUserByIdResponse, GetUsersBulkResponse } from './types.gen';
...
const postIndexSchemaResponseTransformer = (data: any) => {
    data = BigInt(data.toString());
    return data;
};
