...
import type { GetCategoriesResponse, GetCategoryResponse, GetCategoryThreadsResponse, GetForumsCountResponse, GetForumsResponse, GetForumResponse, GetPostsResponse, GetThreadsResponse, GetThreadsCountResponse, GetThreadResponse, GetPostOrderResponse, CreatePostResponse, GetUserNotificationResponse, GetUsersResponse, GetUserByIdResponse, GetUsersByIdsResponse } from './types.gen';
...
const internalUserNotificationDtoSchemaResponseTransformer = (data: any) => {
...
const internalUserNotificationsDtoSchemaResponseTransformer = (data: any) => {
...
export const getUserNotificationResponseTransformer = async (data: any): Promise<GetUserNotificationResponse> => {
    data = internalUserNotificationsDtoSchemaResponseTransformer(data);
    return data;
};
