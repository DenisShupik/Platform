 ...
 * OK
 */
export const vGetThreadsCountResponse = v.union([
    v.pipe(v.union([
        v.number(),
        v.string(),
        v.bigint()
 ...
 * OK
 */
export const vGetInternalNotificationCountResponse = v.union([
    v.pipe(v.number(), v.integer(), v.minValue(-2147483648, 'Invalid value: Expected int32 to be >= -2^31'), v.maxValue(2147483647, 'Invalid value: Expected int32 to be <= 2^31-1')),
    v.pipe(v.string(), v.regex(/^-?(?:0|[1-9]\d*)$/))
]);
