...
import { PolicyType, PolicyValue } from './types.gen';
...
export const vCreateForumRequestBody = v.object({
    title: vForumTitle,
    accessPolicyValue: vPolicyValue,
    categoryCreatePolicyValue: vPolicyValue,
    threadCreatePolicyValue: vPolicyValue,
    postCreatePolicyValue: vPolicyValue
});

export const vPolicyType = v.enum(PolicyType);
